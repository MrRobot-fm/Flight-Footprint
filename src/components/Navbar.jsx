...
const Navbar = () => {
  ...
  return (
    ...
    >
      <nav
        className={`${styles.boxWidth} flex sm:py-7 py-10 sm:mb-0 mb-2 justify-between items-center text-secondary dark:text-white relative`}
      >
        ...
        <div className="md:hidden flex flex-1 justify-between items-center ">
          <button
            className="md:hidden w-[3.2rem] h-[3.2rem]  fixed ss:top-[1.8rem] top-[2.4rem] right-[1rem] bg-white mr-[1rem] rounded-full z-[1550] cursor-pointer shadow-md"
          ...
          <div
            className={
              toggle
                ? ' h-[3.2rem] w-[3.2rem] rounded-[50%] fixed  ss:top-[1.8rem]  top-[2.4rem] right-[2rem] z-[1000] radial-gradient dark:bg-radialModalGradient scale-[70]  ease-in-out duration-[1s] '
                : 'h-[3.2rem] w-[3.2rem] rounded-[50%] fixed  ss:top-[1.8rem]  top-[2.4rem] right-[2rem]  radial-gradient ease-in-out duration-[1s]  z-[1000]  radial-gradient dark:bg-radialModalGradient'
            }
          >
            &nbsp;
          </div>
