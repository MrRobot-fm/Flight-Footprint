      ...
      {queryCodeFrom && queryCodeTo && passenger && footprint ? (
        <>
          <div className={`flex flex-col w-full font-semibold items-center `}>
            <h5 className="xs:text-[2.2rem] text-[1.5rem] text-primary">
              Flight:
            </h5>
            <div className="xs:text-[2.8rem] text-[2rem] text-secondary  flex items-center w-[65%] justify-center gap-2 ">
          ...
          <div className="flex flex-col items-center font-semibold">
            <h5 className="xs:text-[2.2rem] text-[1.4rem] text-primary">
              Total CO2:
            </h5>

            <span className="xs:text-[2.7rem] text-[2rem] text-secondary">
